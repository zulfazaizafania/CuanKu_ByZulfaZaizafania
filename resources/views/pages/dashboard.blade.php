...
<div class="col-xl-7 chart" style="margin: 0 auto;">
    <div class="card card-chart">
        <h3 class="card-header">Alokasi Biaya</h3>
        <div class="chart-container ov-h">
            <div id="flotPie1" class="float-chart"></div>
        </div>
        <div class="legend-chart">
            <h4 class="Prioritas">
                <i class="menu-icon fa fa-cube"></i> Tabungan
            </h4>
            <h4 class="Ingin">
                <i class="menu-icon fa fa-cube"></i> Ingin
            </h4>
            <h4 class="Tabungan">
                <i class="menu-icon fa fa-cube"></i> Prioritas
            </h4>
        </div>
    </div>
</div>
